...
export const metadata: Metadata = {
  ...
  description:
    "Full-Stack and AI Engineer in Nairobi shipping production AI products — multi-agent pipelines, RAG, and tool use on Claude and open models, full-stack on Next.js, Django, and Postgres, with safety floors and graceful fallbacks that keep working when the model doesn't.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Full-Stack and AI Engineer in Nairobi. I ship production AI products — multi-agent pipelines, RAG, and tool use on Claude and open models — full-stack on Next.js, Django, and Postgres.",
  },
  twitter: {
    card:        "summary_large_image",
    title:       "Virginia Mwega — Full-Stack and AI Engineer",
    description: "Full-Stack and AI Engineer in Nairobi shipping production AI products — multi-agent pipelines, RAG, and tool use on Claude and open models.",
    creator:     "@veemwega2",
  },
  robots: {
    index:  true,
